...
if ("1" == $result_check_user [0]->is_review) {
	$sql_where = "
				where vis in (1, 2) and is_effect in(2,3) and is_case=0
				";
} else {
	/**
	...
	$sql_where = "
				where vis = 2
				and is_effect in(2,3) and    is_case=0
					";
}
/**
...
$sql_order_by_condition = "
							  and is_delete=0 order by sort desc,is_effect asc, update_time desc
							";
