...
/**********获取融资记录信息******************/
$event_list_sql="
			SELECT id,period,investor_amount,investor_time,is_csdk_partake FROM cixi_deal_trade_event AS event  WHERE `event`.deal_id=?  ORDER BY investor_time asc,id asc ";
