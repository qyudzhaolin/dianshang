...
((function(){
    $('input[name=mobile_login],input[name=user_pwd_login],[id=login_button]').on('focus',function(){
        clear_register();
    }); 
    $('input[name=mobile],input[name=user_pwd],input[name=img_verify],[id=btn_verify_code],[id=register_button],input[name=message]').on('focus',function(){
       clear_login();
    }); 
