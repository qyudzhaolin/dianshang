$(function(){
    //下三角控制
    $('.information_box .bar').css({'left':45});
    $('.information_box li').bind('click',function(){
		...
		switch(this_index){
			case 0:
				...
				break;
			case 1:
				$('.information_box .bar').css({'left':162});
				break;
			case 2:
				$('.information_box .bar').css({'left':280});
				break;
			case 3:
				$('.information_box .bar').css({'left':381});
				break;
			case 4:
				$('.information_box .bar').css({'left':484});
				break;
			case 5:
				$('.information_box .bar').css({'left':586});
				break;
		}
    });
    //新闻动态 切换
