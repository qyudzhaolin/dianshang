...
{//类定义开始
     ...
     * @return string
     +----------------------------------------------------------
     */
    static function buildImageVerify($length=4,$mode=1,$type='gif',$width=48,$height=22,$verifyName='verify',$source)
    {
        ...
        if($source=='admin'){
            ...
            for($i=0;$i<$length;$i++) {
                imagestring($im,5,$i*20+20,mt_rand(5,15),$randval{$i}, $stringColor);
            }
        }
